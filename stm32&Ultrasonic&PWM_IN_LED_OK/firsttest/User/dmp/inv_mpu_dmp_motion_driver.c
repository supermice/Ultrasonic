...
#include <stdint.h>
#include <stdlib.h>
#include <string.h>//wfh uncommit 15.10.25
#include <math.h>
#include "inv_mpu.h"
...
int dmp_enable_feature(unsigned short mask)
{
    ...
    /* Send gesture data to the FIFO. *///姿态数据发入fifo
    ...
    short *sensors, unsigned char *more)
{
    ...
    if (dmp.feature_mask & (DMP_FEATURE_LP_QUAT | DMP_FEATURE_6X_LP_QUAT)) {
        ...
        quat[0] = ((long)fifo_data[0] << 24) | ((long)fifo_data[1] << 16) |
            ((long)fifo_data[2] << 8) |(long) fifo_data[3];
        quat[1] = ((long)fifo_data[4] << 24) | ((long)fifo_data[5] << 16) |
            ((long)fifo_data[6] << 8) |(long) fifo_data[7];
        quat[2] = ((long)fifo_data[8] << 24) | ((long)fifo_data[9] << 16) |
            ((long)fifo_data[10] << 8) |(long) fifo_data[11];
        quat[3] = ((long)fifo_data[12] << 24) | ((long)fifo_data[13] << 16) |
            ((long)fifo_data[14] << 8) |(long) fifo_data[15];
