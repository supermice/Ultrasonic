...
#include <stdint.h>
#include <stdlib.h>
//#include <clock.h>	//wfh 15.10.23
#include "delay.h"	//wfh 15.10.23
#include <string.h>	//wfh 15.10.23
#include "math.h"
#include "inv_mpu.h"
#include "i2c.h"
...
//#define i2c_write   I2C_WriteN//#define i2c_write   msp430_i2c_write	//wfh 15.10.23
#define i2c_write I2C_Write_dmp	//wfh 15.10.23
//#define i2c_read    I2C_ReadN	//wfh 15.10.23
#define i2c_read    I2C_Read_dmp //wfh 15.10.23
#define delay_ms    Delay_ms	//wfh 15.10.23
//#define get_ms      k60_get_clock_ms	//wfh 15.10.23
#define get_ms stm32_get_ms	//wfh 15.10.23
//#define i2cn I2C0	//wfh 15.10.23
#define i2cn I2C1	//wfh 15.10.23
#define MPU6050	//wfh commit 15.10.25

//u8 iddd[3];wfh 15.10.23
//static inline int reg_int_cb(struct int_param_s *int_param)	//wfh commited 15.10.23
// {
//   ///  return msp430_reg_int_cb(int_param->cb, int_param->pin, int_param->lp_exit,
//    ///     int_param->active_low);
//   return 0;//用param去设置中断参数
// }
 ...
 *  @return     0 if successful.
 */
int mpu_init(struct int_param_s *int_param) //#修改过，原为(int mpu_init(struct int_param_s *int_param))
{
	...
	st.chip_cfg.dmp_sample_rate = 1000; //wfh 15.10.25

    if (mpu_set_gyro_fsr(2000))//自检角速度<2000度每秒
        return -1;
    if (mpu_set_accel_fsr(2))//加速度量程2g
        return -1;
    if (mpu_set_lpf(98))//dlpf的截止频率
        return -1;
    if (mpu_set_sample_rate(1000))//设置采样率
        return -1;
    if (mpu_configure_fifo(0))//禁用fifo,启用时要对应传感器mask
        return -1;
...
int mpu_set_dmp_state(unsigned char enable)
{
    ...
    if (enable) {
        ...
        set_int_enable(0);
        /* Disable bypass mode. */
        mpu_set_bypass(1);/////////////////////////////////////////////修改为启用bpass
        /* Keep constant sample rate, FIFO rate controlled by DMP. */
        mpu_set_sample_rate(st.chip_cfg.dmp_sample_rate);////////////////////////////////修改为定值1000
